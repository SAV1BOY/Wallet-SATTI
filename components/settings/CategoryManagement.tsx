    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-2">
                <h4 className="text-md font-semibold text-zinc-300">{title}</h4>
                <button onClick={() => onAdd(kind)} className="flex items-center gap-1 text-sm text-cyan-400 hover:text-cyan-300">
                    <IconPlus size={16} />
                    Adicionar
                </button>
            </div>
            <div className="space-y-2">
                {items.map(cat => (
                    <div key={cat.id} className="flex items-center justify-between p-2 bg-zinc-800/60 rounded-lg">
                        ...
                        <div className="flex items-center gap-1">
                            <button onClick={() => onEdit(cat, kind)} className="p-2 rounded hover:bg-zinc-700/80 text-zinc-400 hover:text-zinc-100">
                                <IconEdit size={18} />
                            </button>
                            <button onClick={() => onDelete(cat, kind)} className="p-2 rounded hover:bg-zinc-700/80 text-zinc-400 hover:text-rose-400">
