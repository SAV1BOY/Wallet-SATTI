        ...
        <div className="space-y-6">
            <div className="bg-zinc-900 rounded-2xl p-4 border border-zinc-800">
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-semibold text-zinc-100">Orçamento do Mês</h3>
                    <button onClick={onEdit} className="flex items-center gap-2 text-sm text-cyan-400 hover:text-cyan-300">
                        <IconEdit size={16} />
                        Editar
                    </button>
                </div>
                <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                        <div className="text-xs text-zinc-400">Orçado</div>
                        <div className="text-lg font-semibold">{fmtMoney(totals.budgeted, settings.currency)}</div>
                    </div>
                    <div>
                        <div className="text-xs text-zinc-400">Gasto</div>
                    ...
                    <div key={item.id} className="bg-zinc-900 rounded-2xl p-4 border border-zinc-800">
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <div className="text-sm">
                                ...
                                <span className="text-zinc-400"> / {fmtMoney(item.budgeted, settings.currency)}</span>
                            </div>
                        </div>
