  ...
  return (
    <div>
      ...
      <div className="flex gap-6 border-b border-zinc-200 dark:border-zinc-800 mb-4">
        {[{ id: "todos", label: t('transactions.all') }, { id: "receitas", label: t('transactions.income') }, { id: "despesas", label: t('transactions.expenses') }].map((t) => (
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-16 text-zinc-500 dark:text-zinc-400">
          <p className="mb-6">{searchQuery || areFiltersActive ? t('transactions.noResults') : t('transactions.noEntries', { type: t(`transactions.entryTypes.${tab}`) })}</p>
