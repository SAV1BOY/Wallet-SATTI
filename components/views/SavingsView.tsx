    ...
    <div className="bg-white dark:bg-zinc-900 rounded-2xl p-4 border border-zinc-200 dark:border-zinc-800 space-y-3">
      <div className="flex justify-between items-start">
        ...
        <div className="flex items-center gap-1">
          ...
          <button onClick={onDelete} className="p-2 rounded-full hover:bg-zinc-200 dark:hover:bg-zinc-800 text-zinc-500 dark:text-zinc-400 hover:text-rose-500 dark:hover:text-rose-400">
      ...
      <div>
        ...
        <div className="text-right text-xs mt-1 text-zinc-500 dark:text-zinc-400">{progress.toFixed(1)}%</div>
      </div>
